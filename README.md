<img width="486" height="43" alt="屏幕截图 2026-07-23 183117" src="https://github.com/user-attachments/assets/fb43561c-d8f0-4d93-a31e-d66d656921b6" />

# 一位神必高手的发言

出于素质，仅仅是放一张神必高手的发言，引以为戒，希望就使用此项目的每个起码具思考能力与备素质的用户，尊重开发者，不然此补档库不建议使用

出于素质，仅仅是放一张神必高手的发言，引以为戒，希望就使用此项目的每个起码具思考能力与备素质的用户，尊重开发者，不然此补档库不建议使用

出于素质，仅仅是放一张神必高手的发言，引以为戒，希望就使用此项目的每个起码具思考能力与备素质的用户，尊重开发者，不然此补档库不建议使用

补充一嘴，此为撤库转折点，是此补档库永远不能忘记的转折点，本来补档者可以引用原仓库说明的，这下彻底没戏了，大家引以为戒

悲报，原作者撤库了，目前我成赛博史官了，我会把源码都编译下来打包完上传，感谢每一位贡献者

# 本人仅赛博补档官，暂时做不到开发与优化新功能，但如果进不去网站，我也会尽我所能尝试到能上网站为止，也仅仅如此

# 分支导航（感谢为Hanime第三方开源客户端作出贡献的所有开发者，本补档者感激不尽）

基于原项目的新分支 https://github.com/daisukiKaffuChino/Han1meViewer/ 感谢这位维护者

参考原项目但界面风格不同的新分支 https://github.com/1wc10086/Han1mePlus 感谢这位维护者

# 提示，由于补档版本与原版本签名不一致，可能导致无root的普通用户无法覆盖安装，因此补档版本是在原版不得以的情况下使用，不建议优先考虑
